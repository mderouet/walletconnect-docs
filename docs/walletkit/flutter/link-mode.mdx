...
1. Add an Universal Link for your wallet in the **Explorer** tab of your [**Cloud project configuration**](https://cloud.walletconnect.com/sign-in), under the **Mobile Linking** section
